...
namespace Sunbox.Avatars {
    ...
    public class AvatarCustomizationEditor : Editor {
        ...
        void OnEnable() {
            ...
            _bodyHeightSerialized = serializedObject.FindProperty(nameof(_instance.bodyHeightMetres));
        ...
        private void DrawBodyProperties_Internal() {
            ...
            AvatarEditorUtilities.AvatarProperty<float>(_instance, serializedObject, nameof(_instance.bodyHeightMetres));

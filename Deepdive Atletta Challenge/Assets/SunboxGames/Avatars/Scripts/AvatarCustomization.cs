...
namespace Sunbox.Avatars
{
    ...
    public class AvatarCustomization : MonoBehaviour
    {
        ...
        [AvatarFloatFieldAttribute("Body Height (m)", "bodyHeightMetres", 1.5f, 2.1f, 1.5f, 2.1f, Section = SECTION_BODY_PARAMETERS)]
        public float bodyHeightMetres = 1.8f;
        ...
        private void UpdateHair_Internal()
        {
            ...
            UClothingItem hatClothingInstance = CurrentBase.GetComponentsInChildren<UClothingItem>()
                .Where(item => item != null && item.ClothingItem != null && item.ClothingItem.SlotType == SlotType.Hat)
                .FirstOrDefault();
            if (hatClothingInstance != null && !hatClothingInstance.ClothingItem.IsEmpty && hairInstance != null && hairInstance.HairItem != null && hairInstance.HairItem.HideHairWhenHatEquipped)
            {
        ...
        private float GetBodyHeightScale_Internal()
        {
            ...
            return bodyHeightMetres / DEFAULT_HEIGHT;
        }
